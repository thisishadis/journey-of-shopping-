...
import {usePostCard} from "./yechi.js";
...
const ProductList = () => {
    ...
    // useEffect(()=>{
    //     axios.get(
    //         `https://search.basalam.com/ai-engine/api/v2.0/product/search?from=0&f.freeShipping=${isFreeDeliveryEnabled}&f.vendorScore=true&filters.slug=handmade-leather-accessory&dynamicFacets=true&size=48&adsImpressionDisable=false&userCityId=1722`,
    //         {
    //             headers: {
    ...
    //         }
    //     )
    // },[isFreeDeliveryEnabled,isBestSellerEnabled])
